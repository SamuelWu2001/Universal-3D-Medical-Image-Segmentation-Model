...
print('check:', args.data_path, args.gpu, args.gpu_device, args.distributed, args.dataset)
...
print('Samuel', start_epoch, best_tol)
...
if args.mod == 'sam_adpt':
    net.eval()
    dice = function.test_sam(args, nice_test_loader, start_epoch, net)
    logger.info(f'DICE: {dice} || @ epoch {start_epoch}.')
