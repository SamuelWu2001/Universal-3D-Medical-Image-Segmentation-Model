...
def parse_args():    
    ...
    parser.add_argument('-plabel', type=int, default=None , help='point label')
    parser.add_argument('-threshold', type=float, default=None , help='segment threshold')
    parser.add_argument('-eval_freq',type=int,default=1,help='interval between each performance evaluation')
    parser.add_argument(
    '-data_path',
    type=str,
    default='../data',
